...
//
//    public MongoDBFactory(final Mongo mongo, final String defaultDatabaseName) {
//        super(mongo, defaultDatabaseName);
//        logger.debug("Instantiating " + MongoDBFactory.class.getName() + " with default database name: " + defaultDatabaseName);
